...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
		...
		$accdate = date('y-m-d');
		$ins_sql = "INSERT INTO accounts(accno,accopendate,accounttype,accountbalance, emailid, pass) VALUES ('".$accno."', '".$accdate."','".$acctype."','".$accbalance."', ".$email."', '".$password."')";
		...
		// 	$in_sql = "INSERT INTO customers(accno, emailid, pass) VALUES ('".$accno."', '".$email."', '".$password."')";
