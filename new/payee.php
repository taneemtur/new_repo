...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			if($temp>0){
				...
				$accname = $_POST['payeename'];
				
				$acctype = $_POST['accounttype'];
			

				$ins_sql = "INSERT INTO registered_payee(payeename, accountnumber, accounttype) VALUES ('".$accname."', '".$accno."', '".$acctype."')";
	...
	<form class="form-horizontal" action="payee.php" method="post" role="form">
				<div class="form-group">
					<label for="name" class="col-sm-3 control-label">Full Name *</label>
						<div class="col-sm-8">
							<input type="text" name="payeename" class="form-control" placeholder="Enter your name" id="accname" required>
						</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="name" class="col-sm-3 control-label">Account type *</label>
						<div class="col-sm-8">
							<select class="form-control" name="accounttype" id="acctype">
