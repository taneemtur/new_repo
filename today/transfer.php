		...
		<li><a href="customerloans.php"><span style="margin-left: 25px; margin-top: 20px; font-size: 20px;"><b>Loan info</b></span></a></li>
			...
			<div class="container">
				<article class="row">
					...
					<div class="form-group">
						<label for="number" class="col-sm-3 control-label">Enter Payee Name *</label>
							<div class="col-sm-8">
								<input type="number" name="name1" class="form-control" placeholder="Enter the name" id="name1" required>
							</div>
					</div>
					<div class="form-group">
